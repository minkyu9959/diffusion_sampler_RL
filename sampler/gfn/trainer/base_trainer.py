...
from task import BaseEnergy, compute_all_metrics, Plotter
...
class BaseTrainer(abc.ABC):
    ...
    def __init__(
        ...
        self.plotter = Plotter(energy_function)
    ...
    def train(self):
        ...
        for epoch in trange(self.max_epoch + 1, dynamic_ncols=True):
